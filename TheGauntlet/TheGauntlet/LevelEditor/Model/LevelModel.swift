      ...
      while w >= 0 {
        if let anElement : ElementModel = self.elementAtPosition(PositionModel(x: w, y: h, z: 0, orientation: Orientation.Right)) {
          ...
          case BaseType.Block:
            ...
            switch specifictype {
            case SpecificTypeBlock.Boulder, SpecificTypeBlock.Wall, SpecificTypeBlock.BoulderCracked, SpecificTypeBlock.Tree, SpecificTypeBlock.BurningTree:
          ...
          case BaseType.Item:
            ...
            switch specifictype {
            case SpecificTypeItem.Rope, SpecificTypeBlock.Glove, SpecificTypeBlock.Hammer, SpecificTypeBlock.Axe, SpecificTypeBlock.WaterSeal:
